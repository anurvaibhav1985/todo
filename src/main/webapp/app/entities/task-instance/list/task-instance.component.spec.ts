...
describe('Component Tests', () => {
  describe('TaskInstance Management Component', () => {
    let comp: TaskInstanceComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TaskInstanceComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.taskInstances?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
